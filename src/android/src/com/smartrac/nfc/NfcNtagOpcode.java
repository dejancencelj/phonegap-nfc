...
public class NfcNtagOpcode {
    ...
    public static final byte PWD_AUTH = (byte) 0x1B;
    ...
    public static final int UNLOCK_CARD = -1;
    public static final int WRITE_OK = 10;

    public static final byte PWD_AUTH_WRITE = (byte) 0x2B;
    public static final byte AUTH_0 = (byte) 0x29;//213!

    public static final byte SERIAL = (byte) 0x00;
